...
model_info_infinite = pd.read_csv(experiment_folder + "toy_data_bottleneck_infinite.csv")
model_info = model_info.append(model_info_infinite).reset_index(drop=True)
...
label_map = {
    "ae-True-True": "Overcomplete AE+Skip",
    "ae-True-False": "Undercomplete AE+Skip",
    "ae-False-True": "Overcomplete AE, no skip",
    "ae-False-False": "Undercomplete AE, no skip",
    "ens-True-True": "Overcomplete BAE+Skip",
    "vae-True-True": "Overcomplete VAE+Skip",
    "infinite-False-True": r"Infinite-width BAE",
}
...
fig.tight_layout()
fig.savefig("2d-toy-bottleneck-infinite.png", dpi=500)
